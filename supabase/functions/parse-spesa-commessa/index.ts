              ...
              function: {
                ...
                parameters: {
                  ...
                  properties: {
                    ...
                    data_scadenza: { type: "string", description: "SOLO per polizze: data di scadenza in formato DD/MM/YYYY. Cerca diciture come 'Scadenza', 'Valida fino al', 'Data scadenza', 'Fine copertura', 'Termine validità', 'Scade il'. Stringa vuota se non è una polizza o se non leggibile." },
                  },
