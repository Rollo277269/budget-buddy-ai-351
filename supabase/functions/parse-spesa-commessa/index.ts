              ...
              function: {
                ...
                parameters: {
                  ...
                  properties: {
                    ...
                    tipo_documento: { type: "string", description: `Tipo di documento. Usa uno dei tipi configurati: ${ruleTypesList}. Se nessuno corrisponde, usa "Altro". IMPORTANTE: classifica come 'Polizza' anche le ricevute/quietanze di pagamento di rate successive di una polizza assicurativa (anche se intitolate 'Ricevuta' o 'Quietanza').` },
                  ...
                  required: ["fornitore", "descrizione", "importo_totale", "imponibile", "imposta", "data_documento", "centro_costo", "tipo_documento", "data_scadenza"],
